...
version: 0.1.0
description: >
  DDD Distilled rules (Vernon) — use when business complexity, language ambiguity, or integration risk makes modeling impact implementation decisions
category: architecture
tags: [ddd-distilled, rules, best-practices]
platforms:
  - claude-code
  - gemini-cli
