...
version: 0.1.0
description: >
  Refactoring rules (Fowler) — use when changing existing code, preparing features, reviewing cleanup without changing observable behavior
category: engineering
tags: [refactoring-fowler, rules, best-practices]
platforms:
  - claude-code
  - gemini-cli
