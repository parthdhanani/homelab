...
version: 0.1.0
description: >
  The Pragmatic Programmer rules (Hunt & Thomas) — use for accountable delivery, adaptability, and code that stays easy to change
category: engineering
tags: [pragmatic-programmer, rules, best-practices]
platforms:
  - claude-code
  - gemini-cli
