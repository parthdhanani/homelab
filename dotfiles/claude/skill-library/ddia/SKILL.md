...
version: 0.1.0
description: >
  DDIA rules (Kleppmann) — use for systems requiring data correctness, consistency, durability, replication, partitioning, or event flow
category: engineering
tags: [ddia, rules, best-practices]
platforms:
  - claude-code
  - gemini-cli
